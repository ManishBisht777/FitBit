  ...
  return (
    <main>
      <section className="relative container p-10 bg-primary text-primary-foreground rounded-[3rem] mt-4">
        <h1 className=" font-heading text-2xl tracking-tight font-semibold  uppercase border-b-2 pb-2 border-black/70 offset">
        ...
        <div className="flex flex-col gap-2 mt-6 text-9xl font-heading tracking-tighter uppercase">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-6 items-center">
              <p>The better</p>
              <p className="text-base font-sans font-medium tracking-normal capitalize w-60">
      ...
      <section className="container p-10 text-primary">
        <h3 className="font-heading text-6xl uppercase">
        ...
        <div className="grid grid-cols-3 gap-4 mt-6 ">
          <div className="bg-slate-900 relative rounded-3xl px-6 py-16 flex items-end flex-col gap-4">
            ...
            <p className="text-end text-primary/70">
      ...
      <section className="container p-10 text-primary ">
        ...
        <div className="flex gap-8 justify-center mt-10 font-heading text-3xl text-primary/50 uppercase">
          <span>all</span>
      ...
      <section className="container font-heading p-10 text-primary-foreground bg-primary rounded-[3rem] mt-4">
        ...
        <div className="mt-6 text-primary bg-primary-foreground p-10 rounded-[3rem]">
      ...
      <section className="container my-10 p-10 flex relative">
        <div className="flex justify-between items-center w-full">
          <div className="flex flex-col font-heading text-6xl gap-2 text-primary max-w-xl uppercase">
      ...
      <section className="container font-heading text-5xl text-primary/50 my-10 p-10 border-y-2 border-primary-foreground/50 uppercase">
        feel great. <span className="text-primary">body and mind.</span>
      </section>

      <section className="flex justify-center gap-6 font-heading text-primary text-4xl">
